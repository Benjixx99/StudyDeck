...
import bx.app.data.constants.CardFailing
...
internal data class DeckEntity(
    ...
    @ColumnInfo(name = "learn_both_sides") val learnBothSides: Boolean = false,
    @ColumnInfo(name = "on_failing") val onFailing: Int = CardFailing.MOVE_TO_START,
) : BaseEntity() {
